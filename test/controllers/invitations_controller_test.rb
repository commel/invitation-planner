...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { accepted: @invitation.accepted, invited: @invitation.invited, name: @invitation.name, payed: @invitation.payed }
    end
  ...
  test "should update invitation" do
    patch :update, id: @invitation, invitation: { accepted: @invitation.accepted, invited: @invitation.invited, name: @invitation.name, payed: @invitation.payed }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
